      ...
      sfY(screenFactorY)
{
  ...
  asteroids.emplace_back(std::make_unique<Asteroid *>(new Asteroid(screen_width, screen_height, screen_width, sfY * screen_height * 25 / 100 / sfY, sfX * 15, sfX * 45.0, -sfY * 9.0, asteroidPaths[5], sfX * (game_start + 45000))));
  asteroids.emplace_back(std::make_unique<Asteroid *>(new Asteroid(screen_width, screen_height, screen_width, sfY * screen_height * 25 / 100 / sfY, sfX * 20, sfX * 18.0, -sfY * 9.0, asteroidPaths[6], sfX * (game_start + 48000))));
  asteroids.emplace_back(std::make_unique<Asteroid *>(new Asteroid(screen_width, screen_height, screen_width, sfY * screen_height * 25 / 100 / sfY, sfX * 16, sfX * 25.0, -sfY * 9.0, asteroidPaths[7], sfX * (game_start + 50000))));
  asteroids.emplace_back(std::make_unique<Asteroid *>(new Asteroid(screen_width, screen_height, screen_width, sfY * screen_height * 25 / 100 / sfY, sfX * 18, sfX * 28.0, -sfY * 9.0, asteroidPaths[8], sfX * (game_start + 55000))));
  asteroids.emplace_back(std::make_unique<Asteroid *>(new Asteroid(screen_width, screen_height, screen_width, sfY * screen_height * 25 / 100 / sfY, sfX * 25, sfX * 45.0, -sfY * 9.0, asteroidPaths[9], sfX * (game_start + 55100))));
  asteroids.emplace_back(std::make_unique<Asteroid *>(new Asteroid(screen_width, screen_height, screen_width, sfY * screen_height * 25 / 100 / sfY, sfX * 18, sfX * 30.0, -sfY * 9.0, asteroidPaths[10], sfX * (game_start + 56000))));

 // set up the bonus bodies
  asteroids.emplace_back(std::make_unique<Asteroid *>(new Asteroid(screen_width, screen_height, screen_width, sfY * screen_height * 25 / 100 / sfY, sfX * 30, sfX * 45.0, -sfY * 9.0, asteroidPaths[11], sfX * (game_start + 41000))));

  asteroids.emplace_back(std::make_unique<Asteroid *>(new Asteroid(screen_width, screen_height, screen_width, sfY * screen_height * 25 / 100 / sfY, sfX * 30, sfX * 30.0, -sfY * 9.0, asteroidPaths[12], sfX * (game_start + 51000))));
  asteroids.emplace_back(std::make_unique<Asteroid *>(new Asteroid(screen_width, screen_height, screen_width, sfY * screen_height * 25 / 100 / sfY, sfX * 30, sfX * 25.0, -sfY * 9.0, asteroidPaths[13], sfX * (game_start + 57000))));
}
